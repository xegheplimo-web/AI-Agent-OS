...
ALTER TABLE "audits" ADD COLUMN "active_bucket" text GENERATED ALWAYS AS (CASE WHEN "status" IN ('running', 'waiting_approval') THEN 'active' ELSE NULL END) STORED;--> statement-breakpoint
